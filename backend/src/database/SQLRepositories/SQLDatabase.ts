...
import type { OrdersRepository } from '../../core/database/OrdersRepository.js';
...
import SQLOrdersRepository from './SQLOrdersRepository.js';
...
class SQLDatabase implements Database {
  ...
  constructor(client: PrismaClient) {
    ...
    this.orders = new SQLOrdersRepository(this, client);
